...
export const CHARACTERS: CharacterItem[] = [
  ...
  { char: '学', strokeCount: 8, meaning: '学习', phrase: '学校', category: '动作' },
  { char: '了', strokeCount: 2, meaning: '了（完成）', phrase: '来了', category: '动作' },
  { char: '爱', strokeCount: 10, meaning: '喜爱', phrase: '爱心', category: '家庭' },
  { char: '们', strokeCount: 5, meaning: '表示复数', phrase: '我们', category: '家庭' },
  { char: '对', strokeCount: 5, meaning: '正确 / 答对', phrase: '对了', category: '动作' },
  { char: '爸', strokeCount: 8, meaning: '爸爸', phrase: '爸爸', category: '家庭' },
  { char: '妈', strokeCount: 6, meaning: '妈妈', phrase: '妈妈', category: '家庭' },
  { char: '画', strokeCount: 8, meaning: '画画', phrase: '画图', category: '动作' },
  { char: '打', strokeCount: 5, meaning: '拍打 / 打球', phrase: '打球', category: '动作' },
  { char: '棋', strokeCount: 12, meaning: '棋子 / 下棋', phrase: '下棋', category: '物品' },
  { char: '鸡', strokeCount: 7, meaning: '小鸡', phrase: '公鸡', category: '动物' },
  { char: '字', strokeCount: 6, meaning: '汉字', phrase: '写字', category: '物品' },
  { char: '词', strokeCount: 7, meaning: '词语', phrase: '字词', category: '物品' },
  { char: '语', strokeCount: 9, meaning: '语言', phrase: '语文', category: '物品' },
  { char: '句', strokeCount: 5, meaning: '句子', phrase: '一句话', category: '物品' },
  { char: '桌', strokeCount: 10, meaning: '桌子', phrase: '书桌', category: '物品' },
  { char: '纸', strokeCount: 7, meaning: '纸张', phrase: '白纸', category: '物品' },
  { char: '文', strokeCount: 4, meaning: '文字 / 语文', phrase: '文化', category: '物品' },
  { char: '数', strokeCount: 13, meaning: '数学 / 数字', phrase: '数数', category: '物品' },
  { char: '音', strokeCount: 9, meaning: '声音', phrase: '音乐', category: '物品' },
  { char: '乐', strokeCount: 5, meaning: '快乐 / 音乐', phrase: '欢乐', category: '颜色' },
  { char: '妹', strokeCount: 8, meaning: '妹妹', phrase: '妹妹', category: '家庭' },
  { char: '奶', strokeCount: 5, meaning: '奶奶', phrase: '牛奶', category: '家庭' },
  { char: '皮', strokeCount: 5, meaning: '皮 / 皮肤', phrase: '皮球', category: '人体' },
  { char: '桥', strokeCount: 10, meaning: '小桥', phrase: '木桥', category: '物品' },
  { char: '台', strokeCount: 5, meaning: '台子 / 台子', phrase: '台上', category: '物品' },
  { char: '雪', strokeCount: 11, meaning: '雪花', phrase: '雪人', category: '自然' },
  { char: '家', strokeCount: 10, meaning: '家庭', phrase: '大家', category: '家庭' },
  { char: '是', strokeCount: 9, meaning: '是（判断）', phrase: '也是', category: '动作' },
  { char: '车', strokeCount: 4, meaning: '车子', phrase: '马车', category: '物品' },
  { char: '也', strokeCount: 3, meaning: '也（同样）', phrase: '也是', category: '动作' },
  { char: '秋', strokeCount: 9, meaning: '秋天', phrase: '秋天', category: '自然' },
  { char: '气', strokeCount: 4, meaning: '空气 / 天气', phrase: '生气', category: '自然' },
  { char: '树', strokeCount: 9, meaning: '大树', phrase: '树叶', category: '植物' },
  { char: '片', strokeCount: 4, meaning: '一片', phrase: '卡片', category: '物品' },
  { char: '大', strokeCount: 3, meaning: '大小', phrase: '大人', category: '方位' },
  { char: '会', strokeCount: 6, meaning: '会 / 开会', phrase: '学会', category: '动作' },
  { char: '个', strokeCount: 3, meaning: '个（量词）', phrase: '一个', category: '物品' },
  { char: '的', strokeCount: 8, meaning: '的（助词）', phrase: '我的书', category: '动作' },
  { char: '船', strokeCount: 11, meaning: '小船', phrase: '飞船', category: '物品' },
  { char: '两', strokeCount: 7, meaning: '两个', phrase: '两天', category: '数字' },
  { char: '在', strokeCount: 6, meaning: '在（存在）', phrase: '在家', category: '方位' },
  { char: '里', strokeCount: 7, meaning: '里面', phrase: '家里', category: '方位' },
  { char: '看', strokeCount: 9, meaning: '看见', phrase: '看书', category: '动作' },
  { char: '见', strokeCount: 4, meaning: '看见', phrase: '见面', category: '动作' },
  { char: '闪', strokeCount: 5, meaning: '闪亮', phrase: '闪电', category: '自然' },
  { char: '星', strokeCount: 9, meaning: '星星', phrase: '星空', category: '自然' },
  { char: '江', strokeCount: 6, meaning: '长江', phrase: '江南', category: '自然' },
  { char: '南', strokeCount: 9, meaning: '南方', phrase: '江南', category: '方位' },
  { char: '可', strokeCount: 5, meaning: '可以', phrase: '可爱', category: '动作' },
  { char: '采', strokeCount: 8, meaning: '采 / 采摘', phrase: '采花', category: '动作' },
  { char: '莲', strokeCount: 10, meaning: '莲花', phrase: '莲叶', category: '植物' },
  { char: '东', strokeCount: 5, meaning: '东边', phrase: '东西', category: '方位' },
  { char: '西', strokeCount: 6, meaning: '西边', phrase: '东西', category: '方位' },
  { char: '北', strokeCount: 5, meaning: '北方', phrase: '北方', category: '方位' },
  { char: '说', strokeCount: 9, meaning: '说话', phrase: '小说', category: '动作' },
  { char: '春', strokeCount: 9, meaning: '春天', phrase: '春风', category: '自然' },
  { char: '青', strokeCount: 8, meaning: '青色', phrase: '青蛙', category: '颜色' },
  { char: '蛙', strokeCount: 12, meaning: '青蛙', phrase: '牛蛙', category: '动物' },
  { char: '夏', strokeCount: 10, meaning: '夏天', phrase: '夏夜', category: '自然' },
  { char: '弯', strokeCount: 9, meaning: '弯弯', phrase: '弯路', category: '动作' },
  { char: '就', strokeCount: 12, meaning: '就（靠近）', phrase: '就是', category: '动作' },
  { char: '冬', strokeCount: 5, meaning: '冬天', phrase: '过冬', category: '自然' },
  { char: '远', strokeCount: 7, meaning: '远', phrase: '远方', category: '方位' },
  { char: '色', strokeCount: 6, meaning: '颜色', phrase: '色彩', category: '颜色' },
  { char: '近', strokeCount: 7, meaning: '近', phrase: '靠近', category: '方位' },
  { char: '听', strokeCount: 7, meaning: '听', phrase: '听见', category: '动作' },
  { char: '无', strokeCount: 4, meaning: '没有', phrase: '无力', category: '数字' },
  { char: '声', strokeCount: 7, meaning: '声音', phrase: '笑声', category: '自然' },
  { char: '还', strokeCount: 7, meaning: '还（仍旧）', phrase: '还是', category: '动作' },
  { char: '多', strokeCount: 6, meaning: '多少', phrase: '很多', category: '数字' },
  { char: '黄', strokeCount: 11, meaning: '黄色', phrase: '金黄', category: '颜色' },
  { char: '只', strokeCount: 5, meaning: '只（量词）', phrase: '一只', category: '数字' },
  { char: '猫', strokeCount: 11, meaning: '小猫', phrase: '花猫', category: '动物' },
  { char: '边', strokeCount: 5, meaning: '旁边', phrase: '河边', category: '方位' },
  { char: '鸭', strokeCount: 10, meaning: '鸭子', phrase: '小鸭', category: '动物' },
  { char: '苹', strokeCount: 8, meaning: '苹果', phrase: '苹果', category: '植物' },
  { char: '果', strokeCount: 8, meaning: '水果', phrase: '果实', category: '植物' },
  { char: '杏', strokeCount: 7, meaning: '杏子', phrase: '杏树', category: '植物' },
  { char: '桃', strokeCount: 10, meaning: '桃子', phrase: '桃树', category: '植物' },
  { char: '力', strokeCount: 2, meaning: '力气', phrase: '大力', category: '动作' },
  { char: '双', strokeCount: 4, meaning: '一双', phrase: '双手', category: '数字' },
  { char: '条', strokeCount: 7, meaning: '一条', phrase: '纸条', category: '数字' },
  { char: '么', strokeCount: 3, meaning: '什么', phrase: '怎么', category: '动作' },
  { char: '影', strokeCount: 15, meaning: '影子', phrase: '身影', category: '自然' },
  { char: '前', strokeCount: 9, meaning: '前面', phrase: '前后', category: '方位' },
  { char: '后', strokeCount: 6, meaning: '后面', phrase: '以后', category: '方位' },
  { char: '狗', strokeCount: 8, meaning: '小狗', phrase: '黑狗', category: '动物' },
  { char: '它', strokeCount: 5, meaning: '它（动物）', phrase: '它们', category: '家庭' },
  { char: '好', strokeCount: 6, meaning: '好', phrase: '好朋友', category: '家庭' },
  { char: '朋', strokeCount: 8, meaning: '朋友', phrase: '亲朋', category: '家庭' },
  { char: '友', strokeCount: 4, meaning: '朋友', phrase: '好友', category: '家庭' },
  { char: '尾', strokeCount: 7, meaning: '尾巴', phrase: '尾羽', category: '动物' },
  { char: '巴', strokeCount: 4, meaning: '尾巴', phrase: '巴掌', category: '动物' },
  { char: '谁', strokeCount: 10, meaning: '谁', phrase: '谁知', category: '动作' },
  { char: '长', strokeCount: 4, meaning: '长短', phrase: '长高', category: '方位' },
  { char: '短', strokeCount: 12, meaning: '短', phrase: '短发', category: '方位' },
  { char: '把', strokeCount: 7, meaning: '一把', phrase: '把门', category: '动作' },
  { char: '伞', strokeCount: 6, meaning: '雨伞', phrase: '打伞', category: '物品' },
  { char: '兔', strokeCount: 8, meaning: '兔子', phrase: '白兔', category: '动物' },
  { char: '最', strokeCount: 12, meaning: '最', phrase: '最好', category: '动作' },
  { char: '公', strokeCount: 4, meaning: '公鸡', phrase: '公园', category: '动物' },
  { char: '写', strokeCount: 5, meaning: '写', phrase: '写字', category: '动作' },
  { char: '诗', strokeCount: 8, meaning: '诗歌', phrase: '写诗', category: '物品' },
  { char: '点', strokeCount: 9, meaning: '一点', phrase: '点头', category: '数字' },
  { char: '要', strokeCount: 9, meaning: '要', phrase: '不要', category: '动作' },
  { char: '过', strokeCount: 6, meaning: '过', phrase: '过来', category: '动作' },
  { char: '给', strokeCount: 9, meaning: '给', phrase: '送给', category: '动作' },
  { char: '当', strokeCount: 6, meaning: '当', phrase: '当然', category: '动作' },
  { char: '串', strokeCount: 7, meaning: '一串', phrase: '串门', category: '数字' },
  { char: '以', strokeCount: 4, meaning: '以后', phrase: '以前', category: '动作' },
  { char: '成', strokeCount: 6, meaning: '成 / 完成', phrase: '成功', category: '动作' },
  { char: '彩', strokeCount: 11, meaning: '彩色', phrase: '彩虹', category: '颜色' },
  { char: '半', strokeCount: 5, meaning: '一半', phrase: '半个', category: '数字' },
  { char: '空', strokeCount: 8, meaning: '天空', phrase: '空地', category: '自然' },
  { char: '问', strokeCount: 6, meaning: '问', phrase: '提问', category: '动作' },
  { char: '到', strokeCount: 8, meaning: '到', phrase: '到了', category: '动作' },
  { char: '方', strokeCount: 4, meaning: '方向', phrase: '地方', category: '方位' },
  { char: '没', strokeCount: 7, meaning: '没有', phrase: '没空', category: '数字' },
  { char: '更', strokeCount: 7, meaning: '更', phrase: '更好', category: '动作' },
  { char: '绿', strokeCount: 11, meaning: '绿色', phrase: '绿叶', category: '颜色' },
  { char: '出', strokeCount: 5, meaning: '出 / 出去', phrase: '出来', category: '动作' },
  { char: '睡', strokeCount: 13, meaning: '睡觉', phrase: '入睡', category: '动作' },
  { char: '那', strokeCount: 6, meaning: '那', phrase: '那里', category: '方位' },
  { char: '海', strokeCount: 10, meaning: '大海', phrase: '海边', category: '自然' },
  { char: '真', strokeCount: 10, meaning: '真 / 真的', phrase: '真心', category: '动作' },
  { char: '老', strokeCount: 6, meaning: '老', phrase: '老师', category: '家庭' },
  { char: '师', strokeCount: 6, meaning: '老师', phrase: '师徒', category: '家庭' },
  { char: '吗', strokeCount: 6, meaning: '吗（疑问）', phrase: '好吗', category: '动作' },
  { char: '同', strokeCount: 6, meaning: '同 / 同学', phrase: '同心', category: '家庭' },
  { char: '什', strokeCount: 4, meaning: '什么', phrase: '干什么', category: '动作' },
  { char: '才', strokeCount: 3, meaning: '才', phrase: '刚才', category: '动作' },
  { char: '亮', strokeCount: 9, meaning: '亮 / 明亮', phrase: '月亮', category: '自然' },
  { char: '时', strokeCount: 7, meaning: '时间', phrase: '时候', category: '自然' },
  { char: '候', strokeCount: 10, meaning: '时候', phrase: '气候', category: '自然' },
  { char: '觉', strokeCount: 9, meaning: '觉得', phrase: '睡觉', category: '动作' },
  { char: '得', strokeCount: 11, meaning: '觉得', phrase: '得到', category: '动作' },
  { char: '自', strokeCount: 6, meaning: '自己', phrase: '自由', category: '家庭' },
  { char: '己', strokeCount: 3, meaning: '自己', phrase: '知己', category: '家庭' },
  { char: '很', strokeCount: 9, meaning: '很 / 非常', phrase: '很好', category: '动作' },
  { char: '穿', strokeCount: 9, meaning: '穿', phrase: '穿衣', category: '动作' },
  { char: '衣', strokeCount: 6, meaning: '衣服', phrase: '大衣', category: '物品' },
  { char: '服', strokeCount: 8, meaning: '衣服', phrase: '服从', category: '物品' },
  { char: '快', strokeCount: 7, meaning: '快 / 快乐', phrase: '飞快', category: '动作' },
  { char: '蓝', strokeCount: 13, meaning: '蓝色', phrase: '蓝天', category: '颜色' },
  { char: '又', strokeCount: 2, meaning: '又（再）', phrase: '又快', category: '动作' },
  { char: '笑', strokeCount: 10, meaning: '笑', phrase: '笑话', category: '动作' },
  { char: '着', strokeCount: 11, meaning: '着（状态）', phrase: '看着', category: '动作' },
  { char: '向', strokeCount: 6, meaning: '向 / 方向', phrase: '向前', category: '方位' },
  { char: '和', strokeCount: 8, meaning: '和', phrase: '和气', category: '动作' },
  { char: '贝', strokeCount: 4, meaning: '贝壳', phrase: '宝贝', category: '物品' },
  { char: '娃', strokeCount: 9, meaning: '娃娃', phrase: '女娃', category: '家庭' },
  { char: '挂', strokeCount: 9, meaning: '挂', phrase: '挂上', category: '动作' },
  { char: '活', strokeCount: 9, meaning: '活 / 活动', phrase: '生活', category: '动作' },
  { char: '群', strokeCount: 13, meaning: '一群', phrase: '群众', category: '数字' },
  { char: '竹', strokeCount: 6, meaning: '竹子', phrase: '竹林', category: '植物' },
  { char: '用', strokeCount: 5, meaning: '用', phrase: '有用', category: '动作' },
  { char: '几', strokeCount: 2, meaning: '几 / 多少', phrase: '几个', category: '数字' },
  { char: '步', strokeCount: 7, meaning: '步 / 脚步', phrase: '一步', category: '动作' },
  { char: '为', strokeCount: 4, meaning: '为 / 因为', phrase: '为什么', category: '动作' },
  { char: '参', strokeCount: 8, meaning: '参加', phrase: '参考', category: '动作' },
  { char: '加', strokeCount: 5, meaning: '加 / 参加', phrase: '加法', category: '动作' },
  { char: '洞', strokeCount: 9, meaning: '洞', phrase: '山洞', category: '自然' },
  { char: '乌', strokeCount: 4, meaning: '乌鸦', phrase: '乌黑', category: '动物' },
  { char: '鸦', strokeCount: 9, meaning: '乌鸦', phrase: '寒鸦', category: '动物' },
  { char: '处', strokeCount: 5, meaning: '处 / 到处', phrase: '处处', category: '方位' },
  { char: '找', strokeCount: 7, meaning: '找', phrase: '寻找', category: '动作' },
  { char: '办', strokeCount: 4, meaning: '办 / 办法', phrase: '办公', category: '动作' },
  { char: '许', strokeCount: 6, meaning: '许 / 许多', phrase: '许可', category: '动作' },
  { char: '法', strokeCount: 8, meaning: '办法', phrase: '方法', category: '动作' },
  { char: '放', strokeCount: 8, meaning: '放', phrase: '放开', category: '动作' },
  { char: '进', strokeCount: 7, meaning: '进 / 进来', phrase: '进步', category: '动作' },
  { char: '住', strokeCount: 7, meaning: '住', phrase: '住房', category: '动作' },
  { char: '孩', strokeCount: 9, meaning: '孩子', phrase: '女孩', category: '家庭' },
  { char: '玩', strokeCount: 8, meaning: '玩', phrase: '玩耍', category: '动作' },
  { char: '吧', strokeCount: 7, meaning: '吧（语气）', phrase: '走吧', category: '动作' },
  { char: '发', strokeCount: 5, meaning: '发 / 头发', phrase: '发现', category: '人体' },
  { char: '芽', strokeCount: 7, meaning: '芽', phrase: '发芽', category: '植物' },
  { char: '爬', strokeCount: 8, meaning: '爬', phrase: '爬虫', category: '动作' },
  { char: '呀', strokeCount: 7, meaning: '呀（语气）', phrase: '好呀', category: '动作' },
  { char: '久', strokeCount: 3, meaning: '久 / 很久', phrase: '不久', category: '时间' },
  { char: '回', strokeCount: 6, meaning: '回 / 回来', phrase: '回家', category: '动作' },
  { char: '全', strokeCount: 6, meaning: '全 / 全部', phrase: '安全', category: '数字' },
  { char: '变', strokeCount: 8, meaning: '变 / 变化', phrase: '变大', category: '动作' },
  // —— 生字表补全中漏掉的两个字 ——
  { char: '小', strokeCount: 3, meaning: '大小 / 小', phrase: '小猫小小', category: '动物' },
  { char: '高', strokeCount: 10, meaning: '高 / 高大', phrase: '高高大树', category: '方位' },
