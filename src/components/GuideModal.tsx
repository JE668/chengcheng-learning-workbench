...
const GUIDE_SECTIONS: { icon: string; title: string; text: string }[] = [
  ...
  },
  {
    icon: '🧸',
    title: '怎么收集更多萌可？',
    text: '① 每科打卡召唤学科萌可；② 坚持一练，前期几乎天天解锁新萌可 🧸；③ 用星星币在商城兑换城堡皮肤等道具；④ 城堡被捣蛋萌可溜进来捣乱时，用魔法喷雾帮乐美把它们捉回去，萌可们会重新开心起来！',
  },
  {
    icon: '🔥',
    title: '天天都有新萌可！',
    text: '坚持做每日一练，前期几乎每天都能解锁一只全新萌可入驻城堡（第 2~7 天连续送，之后每隔几天再来一只），并额外收获 10 颗 ⭐ 星星币！坚持越久，奖励越丰厚～',
  },
  {
    icon: '😈',
    title: '没做会怎样？',
    text: '如果当天某一科没做，那科打卡就空着；到了晚上捣蛋萌可会溜进城堡捣乱——别担心，这是和乐美一起把它们捉回去的好机会！记得每天都来练一练哦！',
  },
  {
    icon: '📕',
    title: '错题去哪了？',
