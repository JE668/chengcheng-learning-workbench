...
const GUIDE_SECTIONS: { icon: string; title: string; text: string }[] = [
  {
    icon: '🎯',
    title: '今天怎么打卡成功？',
    text: '每天做「萌可闯关」：语文 10 题、数学 10 题、英语 5 题。哪一科全答对，哪一科就打卡成功 ✅！三科都过，今天就算圆满啦～三科真的可以分开做，先过语文，明天再过数学、英语，慢慢来没关系！',
  },
  {
    icon: '🏅',
    title: '怎么赚积分（最想要的）？',
  ...
  },
  {
    icon: '🌟',
    title: '学习星怎么拿？',
    text: '在学堂里挑一个模块做题，一轮做完按答对率给星（错得少就星多，最多 3 颗，而且不会掉星）。每天一练全对的那科，也会帮它点亮核心模块 1 颗星！星星越多，封面越好看哦～',
  },
  {
    icon: '📕',
    title: '做错的题去哪了？',
